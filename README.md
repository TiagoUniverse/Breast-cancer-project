...
The 'breast_cancer_project' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] breast_cancer_project_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/breast_cancer_project.job.yml). The schedule
